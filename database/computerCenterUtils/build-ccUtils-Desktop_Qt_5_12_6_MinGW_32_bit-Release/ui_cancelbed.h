...
public:
    ...
    void setupUi(QWidget *cancelBed)
    {
        ...
        layoutWidget->setGeometry(QRect(60, 70, 274, 61));
        ...
        cancelBedWardCombo = new QComboBox(layoutWidget);
        ...
        cancelBedNumInput = new QLineEdit(layoutWidget);
