...
public:
    ...
    void setupUi(QMainWindow *CCUtils)
    {
        ...
        ward_cancel_smile = new QAction(CCUtils);
        ward_cancel_smile->setObjectName(QString::fromUtf8("ward_cancel_smile"));
        ...
        utils_ward->addAction(ward_cancel_smile);
    ...
    void retranslateUi(QMainWindow *CCUtils)
    {
        ...
        ward_cancel_smile->setText(QApplication::translate("CCUtils", "\345\201\234\346\255\242\351\205\215\347\275\256\344\270\255\345\277\203\347\254\221\350\204\270", nullptr));
