...
{
    dbConnection = QSqlDatabase::addDatabase("QMYSQL", "wardLabelScanDb");   // set up database object with db driver and alias
...
void Loginform::login()
{
    ...
    {
        QMessageBox::information(this, tr("信息"), tr("打开数据库失败!!!"));
        return;
    }
    ...
    {
        QMessageBox::information(this, tr("信息"), tr("请检查登记账号与密码状态!!!"));
    }
    else
    {
        accept();
        ...
        if(loginInfo.next())
        {
            ...
            QMessageBox::information(this, tr("信息"), userComment + "登录成功!!!");
        }
        ...
        if(loginFlag.exec())
        {
            QMessageBox::information(this, tr("信息"), tr("登录状态已改变"));
        }
    }
}
